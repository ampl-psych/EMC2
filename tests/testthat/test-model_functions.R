...
test_that("model estimation", {
  ...
  set.seed(123)
  expect_snapshot(init_chains(LNR_s, particles = 10, cores_for_chains = 4)[[1]]$samples)
  expect_snapshot(init_chains(LBA_s, particles = 10, cores_for_chains = 4)[[1]]$samples)
  expect_snapshot(init_chains(RDM_s, particles = 10, cores_for_chains = 4)[[1]]$samples)
  expect_snapshot(init_chains(DDM_s, particles = 10, cores_for_chains = 4)[[1]]$samples)
})
