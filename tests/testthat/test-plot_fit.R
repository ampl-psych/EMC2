...
test_that(paste0("plot_fit_", Sys.info()[1]), {
  vdiffr::expect_doppelganger(paste0("CDFs_plot_fit_", Sys.info()[1]), plot_fit(dat, pp, factors = c("S", "E"), layout = c(2,3)))
  vdiffr::expect_doppelganger(paste0("dens_plot_fit_", Sys.info()[1]),
