...
rdmDynamicDCT3 <- function() {list(
  ...
  Ntransform=function(x) {
    ...
    x[,dimnames(x)[[2]] == 'alpha1'] <- x[,dimnames(x)[[2]] == 'alpha1']*(1-x[,dimnames(x)[[2]] == 'alpha1min']) + x[,dimnames(x)[[2]] == 'alpha1min']
    x[,dimnames(x)[[2]] == 'alpha2'] <- x[,dimnames(x)[[2]] == 'alpha2']*(1-x[,dimnames(x)[[2]] == 'alpha2min']) + x[,dimnames(x)[[2]] == 'alpha2min']
    x[,dimnames(x)[[2]] == 'alpha3'] <- x[,dimnames(x)[[2]] == 'alpha3']*(1-x[,dimnames(x)[[2]] == 'alpha3min']) + x[,dimnames(x)[[2]] == 'alpha3min']
    x
  },
  DCTtransform =function(npars, da, i) {
    dct <- attr(da, 'adapt')[[i]]$dct
