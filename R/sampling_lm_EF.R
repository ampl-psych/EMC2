...
#   proposals_random <- parallel::mclapply(X=1:pmwgs$n_subjects,FUN=start_proposals_random,
#                                   parameters = startpoints_comb, n_particles = particles,
#                                   pmwgs = pmwgs, variant_funs = variant_funs,
#                                   mc.cores = n_cores)
#   proposals_random <- array(unlist(proposals), dim = c(pmwgs$n_pars - sum(pmwgs$grouped) + 2, pmwgs$n_subjects))
#
