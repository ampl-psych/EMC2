...
run_trend_rcpp <- function(data, trend, param, trend_pars, pars_full, return_kernel = FALSE, use_ptrs = FALSE) {
    .Call(`_EMC2_run_trend_rcpp`, data, trend, param, trend_pars, pars_full, return_kernel, use_ptrs)
}
