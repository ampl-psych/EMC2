// SOURCE OF TRUTH: ~/Downloads/julian/nle/handover/nle-methods/port/src/flow_race.cpp
// Verbatim copy (below this header); sha256 of the source file: 67701a892a5e20cf22cda0359c955cb74d324b526682d2971e9830804a11eda1
// Do not edit here without updating the handover source (Phase 2 will add Armadillo batching).
// C++ (Rcpp) evaluator for exported race-model flows (LNR, RDM, ...).
//
// Direct translation of the validated R reference (port/R/flow_race.R),
// which in turn mirrors distrax rational_quadratic_spline.py and
// flow/src/flow/config.py. Model-agnostic: any context dimension, any MLP
// depth/widths, optional LayerNorm, any bin count. Only single-spline
// chains with an exp output transform and a standard-normal base are
// supported (what flow.config.spline_flow builds).
//
