...
This function takes the output from convolve_design_matrix and
transforms it into a design suitable for sampling with EMC2. It properly
configures parameter types, bounds, and transformations for the
specified model.
...
- model:
  ...
  A function that returns a model specification, options are MRI or
  MRI_AR1
