...
SBC_DDM_single <- run_sbc(design_DDM, prior_DDM, replicates = 500, trials = 100, fileName = "WienR_single.RData",
               cores_per_chain = 30)
...
```{r, eval=FALSE}
SBC_LBA <- SBC_hierarchical(design_LBA, prior_in, replicates = 500, trials = 100,
